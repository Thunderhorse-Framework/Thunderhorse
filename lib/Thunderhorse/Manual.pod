...
all controllers call by default). When used in the application class, they will
be passed an additional argument, which will be a C<$controller> instance, after
C<$self>. It may be undef if the error did not come from a controller (for
example the C<404> error).
